...
"1")
    ...
    wget https://raw.githubusercontent.com/jixishi/BE6-shell/main/name.sh
    chmod +x name.sh
    ./name.sh && >>./shpid
    ;;
"2")
    ...
    if [[ $port == $port0 ]]; then
        $port >>port
        wget https://raw.githubusercontent.com/jixishi/BE6-shell/main/port.sh
        chmod +x port.sh
        ./port.sh && >>./shpid
    else
...
wget https://raw.githubusercontent.com/jixishi/BE6-shell/main/start.sh
chmod +x start.sh
